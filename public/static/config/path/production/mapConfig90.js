 ...
 * @LastEditors: ZX Li
 * @LastEditTime: 2026-01-09 19:38:23
 */
...
let rbmqUrl = 'ws://34.121.238.90:15674/ws' //rabbitmq 地址
// 根据配置切换线上线下复盘接口 线上部署改为true
const onlineReview = true
const onlineSIM = true
const online = false
if (online) {
  // 线上
  baseUrl9080 = '34.121.238.90:16008'    //   登录、文书通信
  ...
  baseUrl16006 = '34.121.238.90:16006/'// 实时统计类接口:油量 油耗等

} else {
  // 线下（开发）
  baseUrl9080 = '34.121.238.90:16008'//'172.16.100.74:9080'    //   登录、文书通信
...
if (onlineSIM) {
  afsimUrl = 'http://34.121.238.90'
} else {
  afsimUrl = 'afsim'
}

const baseUrlLayer = 'http://34.15.87.10'    //  影像  8967端口
...
const layersUrlConfig = {
  ...
  urlWindy: `${baseUrlLayer}:9000/windydarkmaps/{z}/{x}/{y}.jpg`,
  //urlWindy2: `${baseUrlLayer2}:8080/tile-server/v1?Layer=arcgis_gridmap&TILEMATRIX={z}&TILECOL={x}&TILEROW={y}`, // 矢量底图
...
const serverUrls = {
  ...
  serversData: 'http://34.121.238.90:16006',
  serversData2: 'http://192.168.1.44:16006',
  serversCalculation: 'http://34.121.238.90:16008/',
  afsimControl: 'http://34.121.238.90:16004',
  serversCommunication: 'http://34.121.238.90:16005/',
  serversCommunication1: 'http://34.121.238.90:16005/', //sse链接
  serversCommunication2: 'http://34.121.238.90:16005/', //sse链接
  serversCommunication3: 'http://34.121.238.90:16005/', //sse链接
  ...
  sceneUrl: 'http://34.121.238.90', // 想定编辑地址
  ...
  reviewService: 'http://34.121.238.92:5000', //复盘回访
...
const experimentalPreparation = "http://34.121.238.90/SAAEdit/#/"; //实验准备分系统
const experimentalResourceManagement = "http://34.121.238.90/data/#/home/battlefield"//实验资源管理分系统
const HomeUrl = "http://10.15.2.12:6060/dist/#/"
const experimentalStatics = "http://34.121.238.90/#/infomationStatistics"; //实验数据统计分系统
