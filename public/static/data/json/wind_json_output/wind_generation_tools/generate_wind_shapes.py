...
def generate_two_routes_converging():
    ...
    for z in range(nz):
        for y in range(ny):
            for x in range(nx):
                line1_dist = abs(2*y - (nx - x))
                line2_dist = abs(2*y - x)
...
print("Generating wind field shapes...")
print()
...
print()
print("All shapes generated!")
print()
print("Generated files:")
print("  1. wind_single_east.json    - Single horizontal (W->E)")
print("  2. wind_single_northeast.json - Single diagonal (NW->SE)")
print("  3. wind_single_curved.json   - Curved route")
print("  4. wind_two_parallel.json   - Two parallel opposite")
print("  5. wind_converging.json     - Two routes converging")
print("  6. wind_crossing.json       - Two routes crossing")
print("  7. wind_branch.json         - Main route with branch")
print("  8. wind_single_south.json   - Single vertical (N->S)")
print("  9. wind_diverging.json      - Diverging from center")
print(" 10. wind_turbulent.json      - Turbulent single route")
