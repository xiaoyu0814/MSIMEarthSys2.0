...
FrustumGeometry.createGeometry = function(frustumGeometry) {
  ...
  positions[16] = positions[4];
  positions[17] = positions[5];
  positions[18] = positions[6];
  positions[19] = positions[7];
  positions[20] = positions[8];
  positions[21] = positions[9];
  positions[22] = positions[10];
  positions[23] = positions[11];
  if (!drawNearPlane) {
