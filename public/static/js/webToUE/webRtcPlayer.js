...
function webRtcPlayer(parOptions, playerId) {
  ...
  this.createWebRtcVideo = function() {
    ...
    video.id = playerId ? playerId + '-streamingVideo' : 'streamingVideo';
  ...
  this.createWebRtcAudio = function() {
    ...
    audio.id = playerId ? playerId + '-streamingAudio' : 'streamingAudio';
    return audio;
  }
