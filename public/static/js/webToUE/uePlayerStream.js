...
function ueStreamApp(playerId) {
  ...
  function showPlayOverlay() {
    ...
    img.id = 'playButton';
    img.src = '/static/billboard/旗子.png';
  ...
  function setupWebRtcPlayer(htmlElement, config) {
    webRtcPlayerObj = new webRtcPlayer(config, playerId);
  ...
  function resizePlayerStyleToArbitrarySize(playerElement) {
    ...
    if (playerElement.style.display == 'block') {
      playerElement.style = "top: 0px; left: 0px; width: " + styleWidth + "px; height: " + styleHeight + "px; cursor: " + styleCursor + "; " + 'display:block;';
    } else {
      playerElement.style = "top: 0px; left: 0px; width: " + styleWidth + "px; height: " + styleHeight + "px; cursor: " + styleCursor + "; " + 'display:none;';
  ...
  function start(isReconnection, url) {
  ...
  function connect(wsurl) {
    ...
    let connectionUrl = wsurl ? wsurl : webSocketUrl;
  ...
  function registerMouse(playerElement) {
    ...
    let player = document.getElementById(playerElement.id);
  ...
  function closeStream(playerId = 'player') {
    if (webRtcPlayerObj) {
