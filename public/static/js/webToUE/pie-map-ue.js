(function (global, factory) {
	...
	Object.assign(Camera.prototype, {
	   ...
	   ** @param {Number} duration -速度，默认5s
	   *
	   * @memberOf Camera#
	   * @returns {Camera} 返回相机
	   */
	  flyTo: function flyTo(_long, lat, zoomDistance, pitch, heading, duration) {
	   ...
	   * @returns {Camera}  返回相机
	   */
	  flyAction: function flyAction(actionData) {
	    var camera = this.statement;
	    var obj = {
	      type: "Invocation",
	      arguments: {
	   ...
	   * @returns {Camera}  返回相机
	   */
	  geoToWorld: function geoToWorld(geoX, geoY, geoZ) {
	    var camera = this.statement;
	    var obj = {
	      type: "Invocation",
	      arguments: {
	   ...
	   * @returns {Camera}  返回相机
	   */
	  worldToScreen: function worldToScreen(worldX, worldY, worldZ) {
	    var camera = this.statement;
	    var obj = {
	      type: "Invocation",
	      arguments: {
