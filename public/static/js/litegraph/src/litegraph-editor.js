...
function Editor(container_id, options) {
    ...
    graphcanvas.background_image = "static/editor/imgs/background.jpg";
    // graphcanvas.background_image = "static/editor/imgs/grid.png";
    ...
    this.addToolsButton(
        "playnode_button",
        "Play",
        "static/image/litegraph/icon-play.png",
    ...
    this.addToolsButton(
        "playstepnode_button",
        "Step",
        "static/image/litegraph/icon-playstep.png",
    ...
    if (!options.skip_livemode) {
        this.addToolsButton(
            "livemode_button",
            "Live",
            "static/image/litegraph/icon-record.png",
    ...
    if (!options.skip_maximize) {
        this.addToolsButton(
            "maximize_button",
            "",
            "static/image/litegraph/icon-maximize.png",
...
Editor.prototype.onPlayButton = function() {
    ...
    if (graph.status == LGraph.STATUS_STOPPED) {
        button.innerHTML = "<img src='static/image/litegraph/icon-stop.png'/> Stop";
        graph.start();
    } else {
        button.innerHTML = "<img src='static/image/litegraph/icon-play.png'/> Play";
        graph.stop();
    }
};
...
Editor.prototype.onLiveButton = function() {
    ...
    button.innerHTML = !is_live_mode
        ? "<img src='static/image/litegraph/icon-record.png'/> Live"
        : "<img src='static/image/litegraph/icon-gear.png'/> Edit";
};
