...
function RenderDynamicCurrent(viewer, Cesium) {
  ...
  this._scale = LayerOceanConfig.scale // 1.0 //生成粒子的缩放因子
  ...
  this.densityScale = LayerOceanConfig.densityScale // 1 //密度比例系数
  this.velocityScale = LayerOceanConfig.velocityScale //1 //速度比例系数
  this.builder = null
}
