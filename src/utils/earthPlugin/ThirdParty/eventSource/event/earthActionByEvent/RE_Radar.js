    ...
    let cusP = new window.EarthPlugn.customPritive(
        ...
        window.EarthViewer
          ...
          EarthAPP.ldzzInternal = setInterval(() => {
            ...
            RadarMsg = {
              Pt: Math.pow(10, 2)*2.5, //雷达的发射功率 W
              Gt: 40, //雷达的天线主瓣增益 db
            ...
            if(entityId == "blue_ew_radar"){
              RadarMsg.radius  =  200*12.5
              RadarMsg.Pt = RadarMsg.Pt*100
            }
                    ...
                    if (e.properties.airplaneAction._value.side === grySide) {
                      ...
                      if (gry.name === e.id && gry.state) {
                        ...
                        disMsg.push({
                          ...
                          Pj: 0.5, //干扰机发射功率
                          Gj: 2, //干扰机的发射增益
                          Bj: 0.5 * Math.pow(10, 6), //干扰机进入雷达天线的信号带宽
