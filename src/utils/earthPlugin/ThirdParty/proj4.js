!(function (a, b) {
  ...
  function a(a, b) {
    if (a[b]) return a[b]
    for (
      var c, d, e = Object.keys(a), f = b.toLowerCase().replace(Ub, ''), g = -1;
      ++g < e.length;
    ...
    ;(this.es = 1 - a * a),
      ...
      this.lat_ts
        ? this.sphere
          ...
          : (this.k0 = jc(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)))
  ...
  function p(a) {
    ...
    if (this.sphere)
      (d = this.x0 + this.a * this.k0 * lc(b - this.long0)),
        (e = this.y0 + this.a * this.k0 * Math.log(Math.tan(Pb + 0.5 * c)))
    else {
      var f = Math.sin(c),
        g = mc(this.e, c, f)
      ;(d = this.x0 + this.a * this.k0 * lc(b - this.long0)),
  ...
  function q(a) {
    var b,
      ...
      d = a.x - this.x0,
      e = a.y - this.y0
    if (this.sphere) c = Ib - 2 * Math.atan(Math.exp(-e / (this.a * this.k0)))
    else {
      var f = Math.exp(-e / (this.a * this.k0))
      if (((c = nc(this.e, f)), -9999 === c)) return null
    }
    return (
      (b = lc(this.long0 + d / (this.a * this.k0))), (a.x = b), (a.y = c), a
    )
  }
  function r() {}
  function s(a) {
  ...
  function y(a, b, c, d, e, f) {
    var g = {}
    return (
      void 0 === a || 'none' === a ? (g.datum_type = Gb) : (g.datum_type = Fb),
      b &&
  ...
  function I(a, b, c) {
    ...
    return (
      ...
      'longlat' === a.projName
        ? (c = { x: c.x * Nb, y: c.y * Nb })
        : (a.to_meter && (c = { x: c.x * a.to_meter, y: c.y * a.to_meter }),
          (c = a.inverse(c))),
      ...
      'longlat' === b.projName
        ? (c = { x: c.x * Ob, y: c.y * Ob })
        : ((c = b.forward(c)),
          b.to_meter && (c = { x: c.x / b.to_meter, y: c.y / b.to_meter })),
  ...
  function R(a) {
      ...
      (h =
        ...
        ((1 - n / 4 - (3 * n * n) / 64 - (5 * n * n * n) / 256) * p -
          ((3 * n) / 8 + (3 * n * n) / 32 + (45 * n * n * n) / 1024) *
            Math.sin(2 * p) +
          ((15 * n * n) / 256 + (45 * n * n * n) / 1024) * Math.sin(4 * p) -
    ...
    var r =
        o *
          ...
          (g +
            ((1 - e + f) * g * g * g) / 6 +
            ((5 - 18 * e + e * e + 72 * f - 58 * c) * g * g * g * g * g) /
              120) +
        5e5,
      s =
        o *
  ...
  function S(a) {
    ...
    'N' > d && (u -= 1e7),
      ...
      (o =
        ...
        ((21 * s * s) / 16 - (55 * s * s * s * s) / 32) * Math.sin(4 * n) +
    ...
    var v =
      ...
      ((g * Math.tan(o)) / j) *
        ((k * k) / 2 -
          ((5 + 3 * h + 10 * i - 4 * i * i - 9 * f) * k * k * k * k) / 24 +
          ((61 + 90 * h + 298 * i + 45 * h * h - 252 * f - 3 * i * i) *
            k *
            k *
            k *
            k *
  ...
  function X(a, b, c) {
    ...
    g > Lc && ((g = g - Lc + Hc - 1), (i = !0)),
      (g === Ic || (Ic > e && g > Ic) || ((g > Ic || Ic > e) && i)) && g++,
      (g === Jc || (Jc > e && g > Jc) || ((g > Jc || Jc > e) && i)) &&
        (g++, g === Ic && g++),
      g > Lc && (g = g - Lc + Hc - 1),
      h > Kc ? ((h = h - Kc + Hc - 1), (i = !0)) : (i = !1),
      (h === Ic || (Ic > f && h > Ic) || ((h > Ic || Ic > f) && i)) && h++,
  ...
  function Y(a) {
    ...
    d = a.substring(f, (f += 2))
    for (var i = W(g), j = Z(d.charAt(0), i), k = $(d.charAt(1), i); k < _(h); )
      k += 2e6
    var l = c - f
    if (l % 2 !== 0)
      throw (
    ...
    return (
      ...
      (p = s + j),
      (q = t + k),
      { easting: p, northing: q, zoneLetter: h, zoneNumber: g, accuracy: m }
    )
  }
  function Z(a, b) {
    for (
  ...
  function $(a, b) {
    ...
    for (var c = Gc.charCodeAt(b - 1), d = 0, e = !1; c !== a.charCodeAt(0); ) {
  ...
  function ba(a) {
    ...
    if (this.es) {
                      ...
                      (5 -
                        ...
                        (k / 30) *
                          (61 +
                            ...
                            330 * o * l +
                            (k / 56) *
                              (1385 + 543 * p - p * o - 3111 * o)))))) +
          this.y0)
    } else {
      var r = i * Math.sin(g)
      if (Math.abs(Math.abs(r) - 1) < Mb) return 93
      if (
        ((c = 0.5 * this.a * this.k0 * Math.log((1 + r) / (1 - r)) + this.x0),
      ...
      0 > f && (d = -d), (d = this.a * this.k0 * (d - this.lat0) + this.y0)
    }
  ...
  function ca(a) {
    ...
    if (this.es)
      ...
      ;(b = Math.sqrt((1 - Math.pow(t, 2)) / (1 + Math.pow(r, 2)))),
        (d = Math.asin(b)),
        0 > g && (d = -d),
        (e = 0 === r && 0 === t ? 0 : lc(Math.atan2(r, t) + this.long0))
    }
  ...
  function da() {
    ...
    ;(this.cgb[0] =
      ...
      (2 +
        b *
          (-2 / 3 +
            b * (-2 + b * (116 / 45 + b * (26 / 45 + b * (-2854 / 675))))))),
      (this.cbg[0] =
        b *
        (-2 +
          b *
            (2 / 3 +
              b *
                (4 / 3 + b * (-82 / 45 + b * (32 / 45 + b * (4642 / 4725))))))),
      (c *= b),
      (this.cgb[1] =
        c *
        (7 / 3 +
          b * (-1.6 + b * (-227 / 45 + b * (2704 / 315 + b * (2323 / 945)))))),
      (this.cbg[1] =
        c *
        (5 / 3 +
          b *
            (-16 / 15 + b * (-13 / 9 + b * (904 / 315 + b * (-1522 / 945)))))),
      (c *= b),
      (this.cgb[2] =
        c *
        (56 / 15 + b * (-136 / 35 + b * (-1262 / 105 + b * (73814 / 2835))))),
      (this.cbg[2] =
        c * (-26 / 15 + b * (34 / 21 + b * (1.6 + b * (-12686 / 2835))))),
      (c *= b),
      (this.cgb[3] =
      ...
      (c = Math.pow(b, 2)),
      (this.Qn =
        (this.k0 / (1 + b)) * (1 + c * (0.25 + c * (1 / 64 + c / 256)))),
      (this.utg[0] =
        b *
        (-0.5 +
          b *
            (2 / 3 +
              b *
                (-37 / 96 +
                  b * (1 / 360 + b * (81 / 512 + b * (-96199 / 604800))))))),
      (this.gtu[0] =
        b *
        (0.5 +
          b *
            (-2 / 3 +
              b *
                (5 / 16 +
                  b * (41 / 180 + b * (-127 / 288 + b * (7891 / 37800))))))),
      (this.utg[1] =
        c *
        (-1 / 48 +
          b *
            (-1 / 15 +
              b * (437 / 1440 + b * (-46 / 105 + b * (1118711 / 3870720)))))),
      (this.gtu[1] =
        c *
        (13 / 48 +
          b *
            (-0.6 +
              b * (557 / 1440 + b * (281 / 630 + b * (-1983433 / 1935360)))))),
      (c *= b),
      (this.utg[2] =
        c *
        (-17 / 480 + b * (37 / 840 + b * (209 / 4480 + b * (-5569 / 90720))))),
      (this.gtu[2] =
        c *
        (61 / 240 +
          b * (-103 / 140 + b * (15061 / 26880 + b * (167603 / 181440))))),
      (c *= b),
      (this.utg[3] =
        c * (-4397 / 161280 + b * (11 / 504 + b * (830251 / 7257600)))),
      (this.gtu[3] =
        c * (49561 / 161280 + b * (-179 / 168 + b * (6601661 / 7257600)))),
      (c *= b),
  ...
  function ja(a) {
    for (
      var b = 1e-14,
        ...
        f = td;
      f > 0 &&
      ((d = 2 * Math.atan(e * sd(this.e * Math.sin(a.y), -0.5 * this.e)) - Ib),
      !(Math.abs(d - a.y) < b));
      --f
    )
      a.y = d
  ...
  function na(a, b, c) {
    return (
      (b *= c), Math.tan(0.5 * (Ib + a)) * Math.pow((1 - b) / (1 + b), 0.5 * c)
    )
  }
  function oa() {
        ...
        : (Math.abs(this.coslat0) <= Mb &&
          ...
          1 === this.k0 &&
            ...
            (this.k0 =
              (0.5 *
                this.cons *
                jc(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts))) /
              mc(
                this.e,
          ...
          (this.X0 =
            2 * Math.atan(this.ssfn_(this.lat0, this.sinlat0, this.e)) - Ib),
  ...
  function pa(a) {
    ...
    return Math.abs(Math.abs(h - this.long0) - Math.PI) <= Mb &&
      ...
      ? ((b =
        ...
        (a.y =
          this.a * b * (this.coslat0 * j - this.sinlat0 * k * Math.cos(l)) +
          this.y0),
        a)
        ...
        Math.abs(this.coslat0) <= Mb
          ...
          : (Math.abs(this.sinlat0) < Mb
              ...
              : ((b =
                  ...
                  (this.cosX0 *
                    (1 + this.sinX0 * d + this.cosX0 * e * Math.cos(l)))),
                (a.y =
                  b * (this.cosX0 * d - this.sinX0 * e * Math.cos(l)) +
                  this.y0)),
  ...
  function qa(a) {
    ...
    if (Math.abs(this.coslat0) <= Mb) {
      ...
      ;(a.x *= this.con),
        ...
        (b = this.con * lc(this.con * this.long0 + Math.atan2(a.x, -1 * a.y)))
  ...
  function sa(a) {
    var b = Math.log(Math.tan(Math.PI / 4 - a.y / 2)),
      ...
      g = Math.atan(
        Math.sin(f) /
          (Math.sin(this.b0) * Math.tan(e) + Math.cos(this.b0) * Math.cos(f))
      ),
      h = Math.asin(
  ...
  function ta(a) {
    for (
      ...
      ;(i =
        ...
        this.e *
          Math.log(
            Math.tan(Math.PI / 4 + Math.asin(this.e * Math.sin(j)) / 2)
          )),
        (k = j),
  ...
  function ua() {
    ...
    ;(this.bl = Math.sqrt(1 + (this.es / (1 - this.es)) * Math.pow(b, 4))),
      (this.al =
        (this.a * this.bl * this.k0 * Math.sqrt(1 - this.es)) / (1 - c * c))
  ...
  function va(a) {
    ...
    if (Math.abs(Math.abs(f) - Ib) <= Mb)
      (d = f > 0 ? -1 : 1),
        (c =
          (this.al / this.bl) * Math.log(Math.tan(Pb + d * this.gamma0 * 0.5))),
      ...
      ;(c =
        ...
        (b =
          Math.abs(Math.cos(this.bl * g)) <= Mb
            ...
            : (this.al *
                Math.atan2(
                  j * Math.cos(this.gamma0) + l * Math.sin(this.gamma0),
                  Math.cos(this.bl * g)
                )) /
              this.bl)
    }
    return (
      this.no_rot
        ...
        : ((b -= this.uc),
          ...
          (a.y =
            this.y0 + b * Math.cos(this.alpha) - c * Math.sin(this.alpha))),
      a
    )
  }
  function wa(a) {
      ...
      Math.abs(h - 1) < Mb
        ...
        : ((a.y = nc(this.e, i)),
          (a.x = lc(
            this.long0 -
              Math.atan2(
                e * Math.cos(this.gamma0) - g * Math.sin(this.gamma0),
  ...
  function ya(a) {
    var b = a.x,
      c = a.y
    Math.abs(2 * Math.abs(c) - Math.PI) <= Mb && (c = kc(c) * (Ib - 2 * Mb))
    var d,
      e,
  ...
  function Ba(a) {
    ...
    return (
      ...
      (c =
        2 *
        (Math.atan(
          (this.k * Math.pow(Math.tan(j / 2 + this.s45), this.alfa)) / b
        ) -
          this.s45)),
      (d = -k * this.alfa),
      (e = Math.asin(
  ...
  function Da() {
    this.sphere ||
      ...
      (this.e2 = Ld(this.es)),
      (this.e3 = Md(this.es)),
      (this.ml0 = this.a * Id(this.e0, this.e1, this.e2, this.e3, this.lat0)))
  }
  function Ea(a) {
    var b,
      c,
    ...
    if (((d = lc(d - this.long0)), this.sphere))
      ...
      ;(b = h * j * (1 - k * i * (1 / 6 - ((8 - i + 8 * l) * k) / 120))),
        (c =
          m - this.ml0 + ((h * f) / g) * k * (0.5 + ((5 - i + 6 * l) * k) / 24))
    }
  ...
  function Fa(a) {
    ...
    if (this.sphere) {
      ...
      ;(b =
        h -
        ((i * Math.tan(h)) / j) * l * l * (0.5 - ((1 + 3 * k) * l * l) / 24)),
  ...
  function Ha(a) {
    ...
    if (((l = lc(l - this.long0)), this.sphere)) {
      if (
        ...
        if (
          (this.mode === this.N_POLE && (d = -d), Math.abs(m + this.phi0) < Mb)
        )
          return null
        ;(c = Pb - 0.5 * m),
      ...
      switch (this.mode) {
        ...
        case this.EQUIT:
          ;(j = Math.sqrt(2 / j)),
            (c =
              this.mode === this.OBLIQ
                ? this.ymf * j * (this.cosb1 * h - this.sinb1 * i * d)
                : (j = Math.sqrt(2 / (1 + i * d))) * h * this.ymf),
            (b = this.xmf * j * i * e)
          break
        case this.N_POLE:
        case this.S_POLE:
  ...
  function Ia(a) {
    ...
    if (this.sphere) {
      var k,
        l = 0,
        m = 0
      if (((k = Math.sqrt(i * i + j * j)), (c = 0.5 * k), c > 1)) return null
      switch (
        ((c = 2 * Math.asin(c)),
        (this.mode !== this.OBLIQ && this.mode !== this.EQUIT) ||
        ...
        case this.OBLIQ:
          ;(c =
            Math.abs(k) <= Mb
              ? this.phi0
              : Math.asin(l * this.sinph0 + (j * m * this.cosph0) / k)),
            (i *= m * this.cosph0),
      ...
      b =
        0 !== j || (this.mode !== this.EQUIT && this.mode !== this.OBLIQ)
          ? Math.atan2(i, j)
          : 0
    } else {
  ...
  function Na(a) {
    ...
    return (
      ...
      this.sphere
        ...
        : ((c = (this.c - d * d) / this.ns0), (g = this.phi1z(this.e3, c))),
  ...
  function Oa(a, b) {
    ...
    for (var i = a * a, j = 1; 25 >= j; j++)
      if (
        ...
        (g =
          ((0.5 * f * f) / d) *
          (b / (1 - i) - c / f + (0.5 / a) * Math.log((1 - e) / (1 + e)))),
        (h += g),
        Math.abs(g) <= 1e-7)
      )
        return h
    ...
    return (
      ...
      g > 0 || Math.abs(g) <= Mb
        ? ((h = this.x0 + (this.a * f * c * Math.sin(d)) / g),
          (i =
            this.y0 +
            (this.a * f * (this.cos_p14 * b - this.sin_p14 * c * e)) / g))
        : ((h = this.x0 + this.infinity_dist * c * Math.sin(d)),
          (i =
            this.y0 +
            this.infinity_dist * (this.cos_p14 * b - this.sin_p14 * c * e))),
      (a.x = h),
      (a.y = i),
      a
    )
  ...
  function Wa(a) {
    var b = a.x,
      ...
      e = Od(c - this.lat0)
    return (
      (a.x = this.x0 + this.a * d * this.rc), (a.y = this.y0 + this.a * e), a
    )
  }
  function Xa(a) {
    var b = a.x,
    ...
    if (((d = g * Math.sin(f)), this.sphere))
      Math.abs(f) <= Mb
        ...
        : ((b = (this.a * Math.sin(d)) / Math.tan(f)),
          (c = this.a * (Od(f - this.lat0) + (1 - Math.cos(d)) / Math.tan(f))))
  ...
  function $a(a) {
    ...
    if (((d = a.x - this.x0), (e = a.y - this.y0), this.sphere))
      if (Math.abs(e + this.a * this.lat0) <= Mb)
        ...
        b = lc(this.long0 + Math.asin((d * Math.tan(i)) / this.a) / Math.sin(c))
      }
      ...
      for (f = ne; f; --f)
        if (
          ...
          (j =
            ...
            ((this.es * Math.sin(2 * i) * (o * o + h - 2 * g * o)) / (4 * l) +
      ...
      ;(l = Math.sqrt(1 - this.es * Math.pow(Math.sin(c), 2)) * Math.tan(c)),
        (b = lc(this.long0 + Math.asin((d * l) / this.a) / Math.sin(c)))
    }
    return (a.x = b), (a.y = c), a
  }
  function _a() {
    ...
    Math.abs(this.lat1 + this.lat2) < Mb ||
      ...
      Math.abs(this.lat1 - this.lat2) < Mb
        ...
        : ((this.sinphi = Math.sin(this.lat2)),
          ...
          (this.ml2 = Id(this.e0, this.e1, this.e2, this.e3, this.lat2)),
  ...
  function qb(a) {
    ...
    return (
      ...
      (i = -2 * g + 1 + 2 * e * e + f * f),
      (n =
        (e * e) / i + ((2 * h * h * h) / i / i / i - (9 * g * h) / i / i) / 27),
      (j = (g - (h * h) / 3 / i) / i),
      (k = 2 * Math.sqrt(-j / 3)),
      (l = (3 * n) / j / k),
    ...
    return this.sphere
      ? Math.abs(this.sin_p12 - 1) <= Mb
        ...
        : ((s = this.sin_p12 * A + this.cos_p12 * B * Math.cos(C)),
          ...
          (a.y =
            this.y0 +
            this.a * r * (this.cos_p12 * A - this.sin_p12 * B * Math.cos(C))),
          a)
      : ((b = Jd(this.es)),
        (c = Kd(this.es)),
        (d = Ld(this.es)),
        ...
        Math.abs(this.sin_p12 - 1) <= Mb
          ...
          : ((h = A / B),
            ...
            (k = Math.atan(
              (1 - this.es) * h + (this.es * i * this.sin_p12) / (j * B)
            )),
            (l = Math.atan2(
              Math.sin(C),
            ...
            (t =
              0 === l
                ? Math.asin(
                    this.cos_p12 * Math.sin(k) - this.sin_p12 * Math.cos(k)
                  )
                : Math.abs(Math.abs(l) - Math.PI) <= Mb
                ? -Math.asin(
                    this.cos_p12 * Math.sin(k) - this.sin_p12 * Math.cos(k)
                  )
                : Math.asin((Math.sin(C) * Math.cos(k)) / Math.sin(l))),
            (m = (this.e * this.sin_p12) / Math.sqrt(1 - this.es)),
            (n =
              (this.e * this.cos_p12 * Math.cos(l)) / Math.sqrt(1 - this.es)),
            (o = m * n),
            (p = n * n),
            (u = t * t),
            (v = u * t),
  ...
  function tb(a) {
    ...
    if (this.sphere) {
      if (((b = Math.sqrt(a.x * a.x + a.y * a.y)), b > 2 * Ib * this.a)) return
      return (
        (c = b / this.a),
        (d = Math.sin(c)),
        (e = Math.cos(c)),
        ...
        Math.abs(b) <= Mb
          ? (g = this.lat0)
          : ((g = de(e * this.sin_p12 + (a.y * d * this.cos_p12) / b)),
            ...
            (f = lc(
              Math.abs(h) <= Mb
                ...
                : this.long0 +
                    Math.atan2(
                      a.x * d,
                      b * this.cos_p12 * e - a.y * this.sin_p12 * d
                    )
            ))),
        (a.x = f),
        (a.y = g),
    ...
    return (
      ...
      Math.abs(this.sin_p12 - 1) <= Mb
        ...
        : ((b = Math.sqrt(a.x * a.x + a.y * a.y)),
          ...
          (t = (-s * s) / (1 - this.es)),
          (u =
            (3 * this.es * (1 - t) * this.sin_p12 * this.cos_p12 * r) /
            (1 - this.es)),
          (v = b / o),
          (w =
            v -
          ...
          (p = Math.asin(
            this.sin_p12 * Math.cos(w) + this.cos_p12 * Math.sin(w) * r
          )),
          (f = lc(
            this.long0 + Math.asin((Math.sin(q) * Math.sin(w)) / Math.cos(p))
          )),
          (g = Math.atan(
            ((1 - (this.es * x * this.sin_p12) / Math.sin(p)) * Math.tan(p)) /
              (1 - this.es)
          )),
          (a.x = f),
          (a.y = g),
          ...
          Math.abs(f) <= Mb
            ...
            : ((g = lc(
                this.long0 +
                  Math.atan2(
                    a.x * d,
                    b * this.cos_p14 * e - a.y * this.sin_p14 * d
                  )
              )),
              (a.x = g),
              (a.y = h),
  ...
  function zb(a) {
    ...
    if (
      ...
      (d = Math.cos(b)),
      (e = Math.tan(c)),
      (h = 1 - d * d * e * e * (1 - Math.cos(Math.atan(1 / Math.cos(g))))),
      -1 > h ? (h = -1) : h > 1 && (h = 1),
      this.face === He.TOP)
    )
      (i = Math.acos(h)),
  ...
  var Tb = { ft: { to_meter: 0.3048 }, 'us-ft': { to_meter: 1200 / 3937 } },
    ...
    Vb = function (b) {
      ...
      for (c in g)
        (d = g[c]),
          c in h
            ? ((e = h[c]), 'function' == typeof e ? e(d) : (f[e] = d))
            : (f[c] = d)
      return (
  ...
  ;(b.prototype.readCharicter = function () {
    ...
    (b.prototype.afterquote = function (a) {
      ...
      throw new Error(
        'havn\'t handled "' + a + '" in afterquote yet, index ' + this.place
      )
    }),
    ...
    (b.prototype.keyword = function (a) {
      ...
      throw new Error(
        'havn\'t handled "' + a + '" in keyword yet, index ' + this.place
      )
    }),
    (b.prototype.neutral = function (a) {
      ...
      if (dc.test(a)) return void this.afterItem(a)
      throw new Error(
        'havn\'t handled "' + a + '" in neutral yet, index ' + this.place
      )
    }),
  ...
  var hc = [
    ...
    mc = function (a, b, c) {
      var d = a * c,
        e = 0.5 * a
      return (d = Math.pow((1 - d) / (1 + d), e)), Math.tan(0.5 * (Ib - b)) / d
    },
    nc = function (a, b) {
      for (
        ...
        if (
          ((c = a * Math.sin(f)),
          (d = Ib - 2 * Math.atan(b * Math.pow((1 - c) / (1 + c), e)) - f),
          (f += d),
          Math.abs(d) <= 1e-10)
        )
          return f
  ...
  ;(wc.MERIT = { a: 6378137, rf: 298.257, ellipseName: 'MERIT 1983' }),
    ...
    (wc.APL4 = { a: 6378137, rf: 298.25, ellipseName: 'Appl. Physics. 1965' }),
    (wc.NWL9D = {
      a: 6378145,
      rf: 298.25,
    ...
    (wc.clrk66 = { a: 6378206.4, b: 6356583.8, ellipseName: 'Clarke 1866' }),
    (wc.clrk80 = {
      a: 6378249.145,
      rf: 293.4663,
    ...
    (wc.engelis = { a: 6378136.05, rf: 298.2566, ellipseName: 'Engelis 1985' }),
    (wc.evrst30 = {
      a: 6377276.345,
      rf: 300.8017,
  ...
  var xc = (wc.WGS84 = { a: 6378137, rf: 298.257223563, ellipseName: 'WGS 84' })
  wc.sphere = {
    a: 6370997,
    b: 6370997,
  ...
  var zc = function (a, b, c) {
      return A(a, b)
        ...
        ? c
        : a.es !== b.es || a.a !== b.a || F(a.datum_type) || F(b.datum_type)
        ? ((c = B(c, a.es, a.a)),
  ...
  var Nc = '2.4.4',
    ...
    bd = function (a, b, c) {
      for (var d = 1 / (1 - b), e = a, f = ad; f; --f) {
        var g = Math.sin(e),
          h = 1 - b * g * g
        if (
          ((h = (_c(e, g, Math.cos(e), c) - a) * (h * Math.sqrt(h)) * d),
          (e -= h),
          Math.abs(h) < Mb)
        )
          return e
    ...
    id = function (a, b) {
      for (
        var c, d = 2 * Math.cos(2 * b), e = a.length - 1, f = a[e], g = 0;
        --e >= 0;
    ...
    od = function (a, b) {
      if (void 0 === a) {
        if (((a = Math.floor((30 * (lc(b) + Math.PI)) / Math.PI) + 1), 0 > a))
          return 0
        if (a > 60) return 60
      }
      return a
    ...
    Id = function (a, b, c, d, e) {
      return (
        a * e - b * Math.sin(2 * e) + c * Math.sin(4 * e) - d * Math.sin(6 * e)
      )
    },
    Jd = function (a) {
