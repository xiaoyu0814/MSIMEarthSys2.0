 ...
 * @Version: 1.0
 * @Author: ZX Li
 * @Date: 2025-09-05 14:47:20
 * @LastEditors: ZX Li
 * @LastEditTime: 2025-09-08 14:23:36
 */
export default function () {
  // 初始化RWR类型sensor
  const createRwr = (params, volumesData) => {
  ...
  // 实体被干扰
  const rwrJam = (params, volumesData) => {
    let entityTarget = window.EarthPlugn.entity._GetCZMLEntity(
      params.name,
      'MSIMEarthCZMLProcessContainer'
    )
  ...
  return { createRwr, rwrJam, removeRwr }
}
