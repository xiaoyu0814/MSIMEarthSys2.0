...
.loading-text {
  margin-top: 20px;
  font-size: 24px;
  font-family: yahei, 'Courier New', monospace;
  font-weight: bold;
  ...
  //   slideUp 1.5s ease-in-out infinite alternate;
  letter-spacing: 2px;
  padding: 10px 20px;
  border-radius: 4px;
...
@keyframes glow {
  from {
    ...
    text-shadow: 0 0 15px rgba(0, 212, 255, 0.8),
      0 0 30px rgba(0, 212, 255, 0.5), 0 0 45px rgba(0, 212, 255, 0.3);
  }
  to {
    background-position: 100% 50%;
    text-shadow: 0 0 25px rgba(0, 212, 255, 1), 0 0 50px rgba(0, 212, 255, 0.7),
