<template>
  <div id="taskCheck">
              ...
              >
                ...
                <div class="form-btnList">
                  ...
                  <el-button
                    type="primary"
                    :icon="Pointer"
                    @click="checkMemberOfTask(store.state.curSceneInfo, false)"
                    >观看推演</el-button
                  >
                  <el-button type="primary" :icon="Pointer" @click="clearUser()"
                    >清除用户</el-button
                  >
                </div>
              </el-form>
    ...
    <div class="clear_dialog">
      <el-dialog v-model="vueData.dialogVisible" title="清空" width="400">
        <span>确定要清空所有用户吗？</span>
        <template #footer>
          <div class="dialog-footer">
            <el-button @click="vueData.dialogVisible = false">取消</el-button>
            <el-button type="primary" @click="clearSeatMember">
              确定
            </el-button>
          </div>
        </template>
...
<script setup>
import { clearSeatMemberSet } from '@/service/taskManagement'
...
let clearSeatMember = () => {
  clearSeatMemberSet().then((res) => {
    console.log('调用清空任务集合中的用户接口', res)
    if (res.code == '200') {
