<template>
  ...
  <div class="float-experiment">
    <el-tooltip effect="light" :content="'实验列表'" placement="top-start">
      <img
        class="left-shrinks"
        :src="
  ...
  <!-- <div class="float-right">
    <el-tooltip effect="light" :content="'实验样本详情'" placement="top-start">
      <img
        class="left-shrinks"
        :src="
          vueData.isrightEcharts
            ? require('@/assets/image/panelIcons/telescoping_1.png')
            : require('@/assets/image/panelIcons/telescoping.png')
        "
  ...
  >
    <experimentList v-show="vueData.isExperimentList" />
  </Transition> -->
  <experimentList v-show="vueData.isExperimentList" />
...
import experimentList from './hooks/experimentList2.vue'
