<template>
  <div
    class="realTimeInfo"
    style="width: 100%; height: calc(100% - 123px); position: relative"
  >
      ...
      <div class="collapse-interaction" id="log_con">
        <div class="single-log" v-for="item in state.logList" :key="item">
          ...
          <div class="log-side animate__animated animate__backInRight">
            <div class="log-item">
              <span class="time" v-if="item.sendTime">{{ item.sendTime }}</span>
              <!-- <span>{{ item.msg }}</span> -->
              <!-- 判断 如果是合并的多条数据 -->
              <div class="msg">
...
import { seaAirJointOperationsSceneTime } from '@/utils/earthPlugin/ThirdParty/eventSource/event/earthEvent/index.js'
    ...
    .collapse-interaction {
      ...
      .single-log {
        ...
        .log-item {
          ...
          text-shadow: 1px 2px 2px rgb(20, 4, 250);
          padding: 10px;
