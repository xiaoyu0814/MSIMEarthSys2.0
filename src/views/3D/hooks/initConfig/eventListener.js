 ...
 * @LastEditTime: 2024-07-31 18:00:13
 * @FilePath: \MSIMEarthSysN\src\views\3D\hooks\initConfig\eventListener.js
...
export function eventListenerInit() {
  ...
  setTimeout(() => {
    setInterval(() => {
      if (window.EarthViewer.clock.multiplier > 2) return
      let labelObj = {
        alpha: 0.01
      }
      let labelObj2 = {
      ...
      for (let id of hideIds) {
        ...
        let tween = gsap.to(labelObj2, {
          ...
          onUpdate: () => {
            ...
            let oldOutLineColor =
              label.outlineColor._value || label.outlineColor
