 ...
 * @LastEditTime: 2024-06-12 14:00:33
...
import { getBattleDamageHistogram } from '@/service/analysisAssess.js'
...
onUnmounted(() => {
  //  getEcharts()
  //  _getBattleDamageHistogram()
})
const _getBattleDamageHistogram = () => {
  getBattleDamageHistogram({}).then((res) => {
    if (res.code != 200) {
...
const getEcharts = () => {
  ...
  let myChart = echarts.init(document.getElementById('damageEchartsAxis'))
