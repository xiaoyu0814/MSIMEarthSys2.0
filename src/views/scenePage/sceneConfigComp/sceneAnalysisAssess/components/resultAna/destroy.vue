 ...
 * @LastEditTime: 2024-06-12 16:46:52
            ...
            >
              <el-table-column prop="side" label="阵营" align="center" fit>
                <template #default="scope">
                 <span>{{scope.row  == 'red' ? '红方':'蓝方'}}</span>
                </template>
              </el-table-column>
              <el-table-column  prop="name"  label="中文名称"  align="center" fit  />
              <el-table-column  prop="ownership"  label="所属兵力"  align="center" fit  />
              <el-table-column  prop="targetType"  label="目标类型"  align="center" fit  />
                <el-table-column prop="isSurvival" label="是否存活" align="center" fit>
                <template #default="scope">
