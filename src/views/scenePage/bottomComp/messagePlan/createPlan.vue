<template>
  <div class="creat_plan animate__animated animate__fadeIn">
    <div class="header">
      <span class="header-left">新增计划</span
    ...
    <div class="creat_plan_content">
      <el-tabs v-model="vueData.activeName" class="demo-tabs">
        ...
        <!-- <el-tab-pane label="环  境" name="environment">
          <environmentPlan></environmentPlan>
        </el-tab-pane>
        <el-tab-pane label="文  电" name="message">
          <message></message>
        </el-tab-pane> -->
      </el-tabs>
    </div>
...
import troops from '@/views/scenePage/bottomComp/messagePlan/troops/index.vue'
import environmentPlan from '@/views/scenePage/bottomComp/messagePlan/environment_plan/index.vue'
import message from '@/views/scenePage/bottomComp/messagePlan/message/index.vue'
