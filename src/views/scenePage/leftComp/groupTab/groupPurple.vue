 ...
 * @Date: 2026-07-09 13:22:55
 * @LastEditors: xujiajia xujiajia@piesat.cn
 * @LastEditTime: 2026-07-09 13:23:56
 * @FilePath: \MSIMEarthSystem\src\views\scenePage\leftComp\groupTab\groupPurple.vue
 * @Description: 紫方编组
-->
<template>
...
const flyToGroup = (data) => {
  ...
  if (store.state.sceneModule.taskGroupChecked.includes(data.code)) {
    ...
    if (targetsIdArr.length > 0) {
      EF.createGroupByTurf(targetsIdArr, 'purple')
