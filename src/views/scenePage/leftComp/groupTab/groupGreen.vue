 ...
 * @Date: 2026-07-09 13:22:42
 * @LastEditors: xujiajia xujiajia@piesat.cn
 * @LastEditTime: 2026-07-09 13:23:34
 * @FilePath: \MSIMEarthSystem\src\views\scenePage\leftComp\groupTab\groupGreen.vue
 * @Description: 绿方编组
-->
<template>
...
const flyToGroup = (data) => {
  ...
  if (store.state.sceneModule.taskGroupChecked.includes(data.code)) {
    ...
    if (targetsIdArr.length > 0) {
      EF.createGroupByTurf(targetsIdArr, 'green')
