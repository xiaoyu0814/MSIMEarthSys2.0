      ...
      <template v-slot="{ data }">
        ...
        <div v-else-if="data.level == '2'">
          ...
          <!-- <el-icon
            ...
            @click.stop="showGzRangeLine(data)"
            title="感知范围包络"
            ><Location
          /></el-icon>
          <el-icon
            style="margin-left: 4px"
            @click.stop="showZzRangeLine(data)"
            title="作战范围包络"
            ><Location
          /></el-icon> -->
        </div>
...
const state = reactive({
  ...
  treeData: [
    ...
    //         {
    //           name: '高度',
    //           code: 'landTargetHeight',
    //           checked: false,
    //           clickable: false
    //         },
    //         {
    //           name: '速度',
    //           code: 'landTargetSpeed',
    //           checked: false,
    //           clickable: false
    //         },
    //         {
    //           name: '航向角',
    //           code: 'landTargetHeading',
    //           checked: false,
    //           clickable: false
    //         },
    //         {
    //           name: '俯仰角',
    //           code: 'landTargetPitch',
    //           checked: false,
    //           clickable: false
    //         },
    //         {
