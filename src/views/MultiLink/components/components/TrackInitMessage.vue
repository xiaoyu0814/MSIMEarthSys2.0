...
emitter.on('RE_STrackInit', (msg) => {
  ...
  // 新日志消息对接
  czmlEventSourceData.msg = `${newValue.sName}探测到了${newValue.tName}`
  if (newValue.sSide) {
...
//   }
//   // 新日志消息对接
//   czmlEventSourceData.msg = `${newValue.sName}对${newValue.tName}进行了干扰`
//   if (newValue.sSide) {
//     czmlEventSourceData.camp = newValue.sSide == 'blue' ? '2' : '1'
//     czmlEventSourceData.color = newValue.sSide == 'blue' ? '#8df6f3' : '#df5a51'
//   }
